...
class TestConduit(object):
    ...
    def test_login(self):
        ...
        self.driver.find_element_by_xpath('//input[@placeholder="Email"]').send_keys("22teszteles@gmail.com")
        self.driver.find_element_by_xpath('//input[@placeholder="Password"]').send_keys("22Teszteles")
        time.sleep(2)
